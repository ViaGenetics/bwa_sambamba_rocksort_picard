...
def main(reads_1, reference, reference_index, read_group_sample, loglevel,
    ...
    advanced_samtools_rocksort_options=None, advanced_sambamba_markdups_options=None,
    ...
    sambamba_sort_cmd = "dx-samtools rocksort {0} -@ {1} -m {2}M -".format(
